...
class Firefighters extends Transcripts {
    ...
    readParams() {
        ...
        if (speaker != null) {
            if (speaker == "true") {
                document.getElementById("speakerToggle").checked = true;
            } else {
                document.getElementById("speakerToggle").checked = false;
            }
        }
        if (query) {
            $('#search').click();
    ...
    getPermalink() {
        ...
        params.set('speaker', document.getElementById("speakerToggle").checked);
    ...
    search() {
        ...
        var url;
        if (document.getElementById('speakerToggle').checked) {
            url = 'full.txt';
        } else {
            url = 'full_unnamed.txt';
        }
